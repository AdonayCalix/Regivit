    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
                ...
                <form action="#" id="form" type="post">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control formulario" id="user_type" name="user_type">
                        ...
                        <div id="faculty_user" class="form-group col-md-12" style="display: none">
                            <label for="">9. Facultad</label>
                            <select class="form-control" name="faculty_user" id="faculty_user">
                                @foreach($faculties_campus as $faculty)
                                    <option value="{{$faculty->code}}">{{$faculty->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div id="faculty" class="form-group col-md-12" style="display: none">
                            <label for="">9. Facultad</label>
                            <select class="form-control" name="faculty[]" id="faculty" multiple>
                                @foreach($faculties_campus as $faculty)
                                    <option value="{{$faculty->code}}">{{$faculty->name}}</option>
                                @endforeach
                            </select>
            ...
            <div class="modal-footer">
                ...
                <button  href="{{route('master_user.index')}}" type="button" class="btn btn-success" id="save">Guardar</button>
            </div>
        </div>
    </div>
</div>